...
<script type="text/javascript">
    $(document).ready(function () {
        $('#generate_barcodes').click(function () {
            window.open(
                'index.php/vendor_items/generate_barcodes/' + table_support.selected_ids().join(':'),
        ...
        //             btn.html(oldText);
        //             alert(data);
        //             window.location.href = "<?php //echo base_url('index.php/vendor_items'); ?>";
        //         },
        //         error: function (data) {
...
<div id="title_bar" class="btn-toolbar print_hide">
    <div class="inner_block">
        <button class='btn btn-info btn-sm pull-right modal-dlg'
                ...
                title='<?php echo lang('customers_import_vendor_items_excel'); ?>'>
    ...
    <div id="toolbar" class="print_hide">
        <div class="pull-left form-inline" role="toolbar">
            ...
            <button id="generate_barcodes" class="btn btn-default btn-sm print_hide"
                    ...
                    title='<?php echo lang('vendor_items_lang.vendor_items_generate_barcodes'); ?>'>
                <span
                    class="glyphicon glyphicon-barcode">&nbsp</span><?php echo lang("vendor_items_lang.vendor_items_generate_barcodes"); ?>
            </button>
