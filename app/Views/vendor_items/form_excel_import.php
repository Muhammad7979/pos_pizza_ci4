...
<?php echo form_open_multipart('vendor_items/do_excel_import/', array('id' => 'excel_form', 'class' => 'form-horizontal')); ?>
<fieldset id="item_basic_info">
    <div class="form-group form-group-sm">
        <div class="col-xs-12">
            <a href="<?php echo base_url('vendor_items/excel'); ?>"><?php echo lang('common_lang.common_download_import_template'); ?></a>
        </div>
    </div>
