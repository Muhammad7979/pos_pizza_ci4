    ...
    <div class="top_block">
        <div class="inner_block">
            <div class="table_outer">
                ...
                <input type="hidden" value="<?php echo isset($edit_quantity) ? : 0; ?>" id="editQuantity" />
                        ...
                        <tr>
                            <td style="width: 100%; text-align: center;">
                                ...
                                color:#2c3e50; font-weight:400; border-radius: 0;"
                                     class='alert'><?php echo $this->lang->line('sales_no_items_in_cart'); ?></div>
                            </td>
                        </tr>
                        <?php
                    } else {
...
//                                    ?>
                    ...
                    <?php if (count($cart) > 0): ?>
                        ...
                        <tr>
                            ...
                            <td class="price_text">
                                <div
                                        class="price"><?php echo to_currency($this->config->item('tax_included') ? $tax_exclusive_subtotal : $subtotal); ?></div>
                            </td>
                        </tr>
                        </tfoot>
                ...
                <div class="bottom_block">
                    ...
                    <div>
                        ...
                        if ($payments_cover_total) {
                            ...
                            <div class="dropdown_col">
                                <p><?php echo $this->lang->line('sales_payment'); ?></p>
                            ...
                            <div class="dropdown_col">
                                <p id="amount_tendered_label"><?php
                                    echo $this->lang->line('sales_amount_tendered'); ?></p>
                        ...
                        <div class="dropdown_col">
                            ...
                            <div class="dropdown_col">
                                <p><?php echo $this->lang->line('sales_payment'); ?></p>
                                <div style="float: right;">
                                <?php echo form_dropdown('payment_type', $payment_options, $this->sale_lib->get_payment_type(),
                                    array('id' => 'payment_types', 'class' => 'selectpicker show-menu-arrow',
                                        'data-style' => 'input', 'data-width' => '145px')); ?>
                                </div>
                            </div>
                            ...
                            <?php if(isset($payment_type) && $payment_type==$this->lang->line('sales_giftcard')){ ?>
                                <div class="dropdown_col">
                                    <p id="amount_giftcard_label"><?php
                                    echo $this->lang->line('sales_giftcard_number'); ?></p>
                            ...
                            <div class="dropdown_col " id="sales_payment_type" style="display: none;">
                                    ...
                                    <?php echo form_radio(array(
                                        ...
                                        'checked'=>TRUE,
                                    'tabindex' => ++$tabindex,)); ?>
                                    <?php echo $this->lang->line('sales_cash'); ?>
                                </label>
                                <label class="radio-inline">
                                    <?php echo form_radio(array(
                                        'name' => 'sales_payment_type',
                                        ...
                                        'checked'=>FALSE,
                                    'tabindex' => ++$tabindex,)); ?>
                                    <?php echo $this->lang->line('sales_credit'); ?>
                                </label>
                            </div>
                            <?php } ?>
                            <?php echo form_close(); ?>
                    ...
                    if ($last_suspended_sale):
                        ...
                        <input type="submit" name="submit" id="unsuspend-last-sale"
                               value="<?php echo $this->lang->line('sales_unsuspend'); ?>"
...
<div id="overall_sale" class="panel panel-default print_hide" style="display: none;">
    <div class="panel-body">
        ...
        <!--                <tr>-->
        <!--                    <th style='width: 55%;'>-->
        <?php //echo $this->lang->line("sales_customer"); ?><!--</th>-->
        ...
        <!--                    <tr>-->
        <!--                        <th style='width: 55%;'>-->
        <?php //echo $this->lang->line("sales_customer_email"); ?><!--</th>-->
        ...
        <!--                    <tr>-->
        <!--                        <th style='width: 55%;'>-->
        <?php //echo $this->lang->line("sales_customer_address"); ?><!--</th>-->
        <!--                        <th style="width: 45%; text-align: right;">-->
        ...
        <!--                    <tr>-->
        <!--                        <th style='width: 55%;'>-->
        <?php //echo $this->lang->line("sales_customer_location"); ?><!--</th>-->
        <!--                        <th style="width: 45%; text-align: right;">-->
        ...
        <!--                <tr>-->
        <!--                    <th style='width: 55%;'>-->
        <?php //echo $this->lang->line("sales_customer_discount"); ?><!--</th>-->
        <!--                    <th style="width: 45%; text-align: right;">-->
        <?php //echo $customer_discount_percent . ' %'; ?><!--</th>-->
        <!--                </tr>-->
        <!--                <tr>-->
        <!--                    <th style='width: 55%;'>-->
        <?php //echo $this->lang->line("sales_customer_total"); ?><!--</th>-->
        <!--                    <th style="width: 45%; text-align: right;">-->
        ...
        <?php //echo $this->lang->line('sales_select_customer'); ?><!--</label>-->
        ...
        <!--                    <span-->
        <!--                        class="glyphicon glyphicon-user">&nbsp</span>--><?php //echo $this->lang->line($controller_name . '_new_customer'); ?>
        <!--                </button>-->
        <!---->
        <!--            </div>-->
        <!--            --><?php //echo form_close(); ?>
