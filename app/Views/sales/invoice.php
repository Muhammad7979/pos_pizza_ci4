...
$(document).ready(function()
{
	...
	{
		$.get('<?php echo base_url() . "/sales/send_invoice/" . $sale_id_num; ?>',
			function(response)
			{
...
<?php view('partial/print_receipt', array('print_after_sale'=>$print_after_sale, 'selected_printer'=>'invoice_printer')); ?>

<div class="print_hide" id="control_buttons" style="text-align:right">
	<a href="javascript:printdoc();"><div class="btn btn-info btn-sm", id="show_print_button"><?php echo '<span class="glyphicon glyphicon-print">&nbsp</span>' . lang('sales_lang.common_print'); ?></div></a>
	<?php /* this line will allow to print and go back to sales automatically.... echo anchor("sales", '<span class="glyphicon glyphicon-print">&nbsp</span>' . lang('sales_lang.common_print'), array('class'=>'btn btn-info btn-sm', 'id'=>'show_print_button', 'onclick'=>'window.print();')); */ ?>
	<?php if(isset($customer_email) && !empty($customer_email)): ?>
		<a href="javascript:void(0);"><div class="btn btn-info btn-sm", id="show_email_button"><?php echo '<span class="glyphicon glyphicon-envelope">&nbsp</span>' . lang('sales_lang.sales_send_invoice'); ?></div></a>
	<?php endif; ?>
...
<div id="page-wrap">
	<div id="header"><?php echo lang('sales_lang.sales_invoice'); ?></div>
	<div id="block1">
        ...
        <div id="logo">
	        <?php if($appData['company_logo'] != '') 
	        { 
			?>
				<img id="image" src="<?php echo base_url('uploads/' . $appData['company_logo']); ?>" alt="company_logo" />			
			<?php
			}
			?>
			<div>&nbsp</div>
			<div id="company_name"><?php echo $appData['company']; ?></div>
        </div>
	</div>
	...
	<div id="block2">
        ...
        <table id="meta">
            <tr>
                <td class="meta-head"><?php echo lang('sales_lang.sales_invoice_number');?> </td>
                <td><textarea rows="5" cols="6"><?php echo $invoice_number; ?></textarea></td>
            </tr>
            <tr>
                <td class="meta-head"><?php echo lang('sales_lang.common_date'); ?></td>
                <td><textarea rows="5" cols="6"><?php echo $transaction_date; ?></textarea></td>
            </tr>
            <tr>
                <td class="meta-head"><?php echo lang('sales_lang.sales_amount_due'); ?></td>
	...
	<table id="items">
		<tr>
			<th><?php echo lang('sales_lang.sales_item_number'); ?></th>
			<th><?php echo lang('sales_lang.sales_item_name'); ?></th>
			<th><?php echo lang('sales_lang.sales_quantity'); ?></th>
			<th><?php echo lang('sales_lang.sales_price'); ?></th>
			<th><?php echo lang('sales_lang.sales_discount'); ?></th>
			<th><?php echo lang('sales_lang.sales_total'); ?></th>
		</tr>
		<?php
		...
		<tr>
			...
			<td colspan="2" class="total-line"><textarea rows="5" cols="6"><?php echo lang('sales_lang.sales_sub_total'); ?></textarea></td>
		...
		<tr>
			<td colspan="3" class="blank"> </td>
			<td colspan="2" class="total-line"><textarea rows="5" cols="6"><?php echo lang('sales_lang.sales_total'); ?></textarea></td>
	...
	<div id="terms">
		<div id="sale_return_policy">
		 	<h5>
			 	<textarea rows="5" cols="6"><?php echo nl2br($appData['payment_message']); ?></textarea>
			  	<textarea rows="5" cols="6"><?php echo lang('sales_lang.sales_comments'). ': ' . (empty($comments) ? $appData['invoice_default_comments'] : $comments); ?></textarea>
		  	</h5>
