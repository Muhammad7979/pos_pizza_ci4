...
<!--		<div id="sale_id">--><?php //echo lang('sales_lang.sales_id').": ".$sale_id; ?><!--</div>-->
		...
		{
		?>
			<div id="invoice_number"><?php echo lang('sales_lang.sales_invoice_number').": ".$invoice_number; ?></div>	
		<?php 
		}
		?>
	...
	<table id="receipt_items">
		<tr>
			...
			<th style="width:20%;" class="total-value"><?php echo lang('sales_lang.sales_total'); ?></th>
		</tr>
		<?php
		...
		?>
			<tr>
				...
				<td class="total-value"><?php echo to_currency($item[($appData['receipt_show_total_discount'] ? 'total' : 'discounted_total')]); ?></td>
			</tr>
			<tr>
				<?php
			...
			?>
				<tr>
					<td colspan="3" class="discount"><?php echo number_format($item['discount'], 0) . " " . lang("sales_discount_included")?></td>
		...
		?> 
			...
			<tr>
				<td colspan="3" class="total-value"><?php echo lang('sales_lang.sales_discount'); ?>:</td>
		...
		<tr>
			<td colspan="3" style="text-align:right;<?php echo $border? 'border-top: 2px solid black;' :''; ?>"><?php echo lang('sales_lang.sales_total'); ?></td>
