	...
	<div id="config_wrapper">
		<fieldset id="config_email">
			...
			<div class="form-group form-group-sm">
				<?php echo form_label(lang('config_lang.config_email_protocol'), 'protocol', array('class' => 'control-label col-xs-2')); ?>
				<div class='col-xs-2'>
					...
					$appData['protocol'], array('class' => 'form-control input-sm', 'id' => 'protocol'));
					?>
				</div>
			</div>

			<div class="form-group form-group-sm">	
				<?php echo form_label(lang('config_lang.config_email_mailpath'), 'mailpath', array('class' => 'control-label col-xs-2')); ?>
				<div class="col-xs-4">
					<?php echo form_input(array(
						'name' => 'mailpath',
						'id' => 'mailpath',
						'class' => 'form-control input-sm',
						'value' => $appData['mailpath'])); ?>
				</div>
			</div>

			<div class="form-group form-group-sm">	
				<?php echo form_label(lang('config_lang.config_email_smtp_host'), 'smtp_host', array('class' => 'control-label col-xs-2')); ?>
				<div class="col-xs-2">
					<?php echo form_input(array(
						'name' => 'smtp_host',
						'id' => 'smtp_host',
						'class' => 'form-control input-sm',
						'value' => $appData['smtp_host'])); ?>
				</div>
			</div>

			<div class="form-group form-group-sm">	
				<?php echo form_label(lang('config_lang.config_email_smtp_port'), 'smtp_port', array('class' => 'control-label col-xs-2')); ?>
				<div class="col-xs-2">
					<?php echo form_input(array(
						'name' => 'smtp_port',
						'id' => 'smtp_port',
						'class' => 'form-control input-sm',
						'value' => $appData['smtp_port'])); ?>
				</div>
			</div>

			<div class="form-group form-group-sm">
				<?php echo form_label(lang('config_lang.config_email_smtp_crypto'), 'smtp_crypto', array('class' => 'control-label col-xs-2')); ?>
				<div class='col-xs-2'>
					...
					$appData['smtp_crypto'], array('class' => 'form-control input-sm', 'id' => 'smtp_crypto'));
					?>
				</div>
			</div>

			<div class="form-group form-group-sm">	
				<?php echo form_label(lang('config_lang.config_email_smtp_timeout'), 'smtp_timeout', array('class' => 'control-label col-xs-2')); ?>
				<div class="col-xs-2">
					<?php echo form_input(array(
						'name' => 'smtp_timeout',
						'id' => 'smtp_timeout',
						'class' => 'form-control input-sm',
						'value' => $appData['smtp_timeout'])); ?>
				</div>
			</div>

			<div class="form-group form-group-sm">	
				<?php echo form_label(lang('config_lang.config_email_smtp_user'), 'smtp_user', array('class' => 'control-label col-xs-2')); ?>
				<div class="col-xs-4">
					<div class="input-group">
						...
						<?php echo form_input(array(
							...
							'id' => 'smtp_user',
							'class' => 'form-control input-sm',
							'value' => $appData['smtp_user'])); ?>
					</div>
				</div>
			</div>

			<div class="form-group form-group-sm">	
				<?php echo form_label(lang('config_lang.config_email_smtp_pass'), 'smtp_pass', array('class' => 'control-label col-xs-2')); ?>
				<div class="col-xs-4">
					<div class="input-group">
