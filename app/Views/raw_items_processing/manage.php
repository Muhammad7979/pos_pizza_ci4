...
<script type="text/javascript">
    $(document).ready(function () {
        $('#generate_barcodes').click(function () {
            window.open(
                'index.php/raw_items_processing/generate_barcodes/' + table_support.selected_ids().join(':'),
        ...
        //             btn.html(oldText);
        //             alert(data);
        //             window.location.href = "<?php //echo base_url('index.php/raw_items_processing'); ?>";
        //         },
        //         error: function (data) {
    ...
    <div id="toolbar" class="print_hide">
        <div class="pull-left form-inline" role="toolbar">
            ...
            <button id="generate_barcodes" class="btn btn-default btn-sm print_hide"
                    ...
                    title='<?php echo lang('raw_items_processing_lang.raw_items_processing_generate_barcodes'); ?>'>
                <span
                    class="glyphicon glyphicon-barcode">&nbsp</span><?php echo lang("raw_items_processing_lang.raw_items_processing_generate_barcodes"); ?>
            </button>
