...
<head>
	...
	<title><?php echo $this->config->item('company') . ' | ' . $this->lang->line('common_powered_by') . ' UnitedSol ' . $this->config->item('application_version') ?></title>
	...
	<?php else : ?>
		...
		<script type="text/javascript" src="dist/opensourcepos.min.js?rel=c72c4d48d0"></script>
		...
		<div class="navbar navbar-default" role="navigation">
			<div class="container">
				<div class="navbar-header">
					...
					<a class="navbar-brand hidden-sm" href="<?php echo site_url(); ?>">USOL</a>
				</div>
				...
				<div class="navbar-collapse collapse">
					<ul class="nav navbar-nav navbar-right">
						...
						?>
						<li>
							<a href="/sales/upload">Upload (<?php echo $sales_count; ?>)</a>
						</li>
						<li>
							<a href="/sales/sync">Sync</a>
						</li>
					</ul>
				</div>
			</div>
