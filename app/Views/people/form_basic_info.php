...
<div class="form-group form-group-sm">	
	<?php echo form_label(lang('common_lang.common_address_1'), 'address_1', array('class'=>'control-label col-xs-3')); ?>
	<div class='col-xs-8'>
		<?php echo form_input(array(
				'name'=>'address_1',
				'id'=>'address_1',
...
<div class="form-group form-group-sm">	
	<?php echo form_label(lang('common_lang.common_address_2'), 'address_2', array('class'=>'control-label col-xs-3')); ?>
	<div class='col-xs-8'>
		<?php echo form_input(array(
				'name'=>'address_2',
				'id'=>'address_2',
...
<div class="form-group form-group-sm">	
	<?php echo form_label(lang('common_lang.common_city'), 'city', array('class'=>'control-label col-xs-3')); ?>
	<div class='col-xs-8'>
		<?php echo form_input(array(
				'name'=>'city',
				'id'=>'city',
...
<div class="form-group form-group-sm">	
	<?php echo form_label(lang('common_lang.common_state'), 'state', array('class'=>'control-label col-xs-3')); ?>
	<div class='col-xs-8'>
		<?php echo form_input(array(
				'name'=>'state',
				'id'=>'state',
...
<div class="form-group form-group-sm">	
	<?php echo form_label(lang('common_lang.common_zip'), 'zip', array('class'=>'control-label col-xs-3')); ?>
	<div class='col-xs-8'>
		<?php echo form_input(array(
				'name'=>'zip',
				'id'=>'postcode',
...
<div class="form-group form-group-sm">	
	<?php echo form_label(lang('common_lang.common_country'), 'country', array('class'=>'control-label col-xs-3')); ?>
	<div class='col-xs-8'>
		<?php echo form_input(array(
				'name'=>'country',
				'id'=>'country',
...
$(document).ready(function()
{
	nominatim.init({
		...
		country_codes: '<?php echo $appData['country_codes']; ?>'
	});
});
</script>