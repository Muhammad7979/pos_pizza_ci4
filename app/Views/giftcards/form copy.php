...
<?php echo form_open('giftcards/save/'.$giftcard_id, array('id'=>'giftcard_form', 'class'=>'form-horizontal')); ?>
	<fieldset id="giftcard_basic_info" <?php echo $style; ?>>
		...
		<div class="form-group form-group-sm">
			<?php echo form_label(lang('giftcards_giftcard_number'), 'name', array('class'=>'required control-label col-xs-3')); ?>
			<div class='col-xs-4'>
				<?php echo form_input(array(
		...
		<div class="form-group form-group-sm">
			<?php echo form_label(lang('giftcards_card_value'), 'name', array('class'=>'required control-label col-xs-3')); ?>
			<div class='col-xs-4'>
				<div class="input-group input-group-sm">
					<?php if (!currency_side($appData)): ?>
		...
		<div class="form-group form-group-sm">
			<?php echo form_label(lang('giftcards_card_expired'), 'expires_at', array('class'=>'required control-label col-xs-3')); ?>
			<div class='col-xs-4'>
	...
	$('#giftcard_form').validate($.extend({
		...
		messages:
		{
			giftcard_number:
			{
				...
				remote:"<?php echo lang('giftcards_number_duplicate'); ?>"
			},
			value:
			{
			...
			expires_at:
			{
				required:"<?php echo lang('giftcards_card_expired_required'); ?>",
			}
		}
	}, form_support.error));
});
