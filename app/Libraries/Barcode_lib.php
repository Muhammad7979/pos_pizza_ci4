...
class Barcode_lib
{
	...
	// public function display_barcode_for_order($order_id, $barcode_config)
	// {
	// 	$display_table = "<table>";
	// 	$barcode = $this->generate_barcode($order_id, $barcode_config);
	// 	$display_table .= "<tr><td align='center'><img src='data:image/png;base64,$barcode' /></td></tr>";
	// 	$display_table .= "<tr><td align='center'>" . $order_id . "</td></tr>";
	...
	public function display_giftcard_barcode($item, $barcode_config)
	{
		$display_table = "<table>";

		$display_table .=  '<tr><td align="center"><img style="width:200px; padding: 0; margin: 0;border-radius: 10px" src='.base_url().'images/tehzeeb/logo.png></td></tr>';
		if(($item['name'])!=''){
		$display_table .= "<tr><td align='center' style='font-size:16px; font-weight:600'>" . $item['name'] . "</td></tr>";
		}
		$barcode = $this->generate_barcode($item, $barcode_config);
		$display_table .= "<tr><td align='center'><img src='data:image/png;base64,$barcode' /></td></tr>";
		$display_table .= "<tr><td align='center'>" . $this->manage_display_layout($barcode_config['barcode_second_row'], $item, $barcode_config) . "</td></tr>";
