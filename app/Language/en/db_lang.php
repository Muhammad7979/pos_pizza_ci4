...
return [
    ...
    'db_unable_to_select' => 'Unable to select the specified database: {0}',
    'db_unable_to_create' => 'Unable to create the specified database: {0}',
    ...
    'db_unable_to_set_charset' => 'Unable to set client connection character set: {0}',
